...
public class rhythmPerformer {
    ...
    public rhythmPerformer(Activity runActivity){
        this.runActivity=runActivity;
        mediaPlayers[1] = MediaPlayer.create(runActivity, R.raw.selectrhythm1);
        mediaPlayers[2] = MediaPlayer.create(runActivity, R.raw.selectrhythm2);
